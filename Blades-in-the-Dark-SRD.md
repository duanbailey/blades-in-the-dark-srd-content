...
* If the highest die is a **6**, it’s a **full success**—things go well. If you roll more than one **6**, it’s a __**critical** success__—you gain some additional advantage.
...
1. **Impaired.** The cohort operates with reduced quality (-1d).
1. **Broken.** The cohort can’t do anything until they recover.
1. **Dead.** The cohort is destroyed.
